...
<title>RUG Psychology timetable</title>
<style>
...
<body>
<div class="card">
  <h1>RUG Psychology — my timetable</h1>
  ...
  <div class="hint">
    ...
    and are shown on your Nestor / course sign-up. You can also pick “None”.
  </div>
...
function refresh() {
  ...
  const picked = (letter ? 1 : 0) + (number ? 1 : 0);
  ...
  countEl.textContent = picked === 0
    ? "Choose at least one group to continue."
    : `${n} events will be in your calendar.`;
}
