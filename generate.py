...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .hero { background: linear-gradient(135deg, #c8102e, #ff5e7e); color: #fff; border-radius: 12px;
          padding: 20px 16px; text-align: center; margin-bottom: 22px;
          box-shadow: 0 6px 20px rgba(200, 16, 46, .35);
          animation: hero-pop .8s cubic-bezier(.175,.885,.32,1.275) both; }
  .hero-title { font-size: 30px; font-weight: 900; letter-spacing: .5px; text-shadow: 0 2px 6px rgba(0,0,0,.2); }
  .hero-sub { font-size: 13px; opacity: .92; margin-top: 4px; }
  @keyframes hero-pop { 0% { transform: scale(.5) rotate(-3deg); opacity: 0; }
...
<div class="card">
  <div class="hero">
    <div class="hero-title">Dankjewel, Johannes!</div>
    <div class="hero-sub">for making your schedule slightly less chaotic</div>
  </div>
